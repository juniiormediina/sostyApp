                ...
                <StyledView className="p-3">
                  ...
                  {aboutSosty[1] == true && (
                    <StyledText
                      ...
                      Sosty es una plataforma de ganadería colaborativa, permite
                  ...
                  {aboutSosty[2] == true && (
                    <StyledText style={styles.innerHelpText} className="mb-1">
                      Democratizar la participación en proyectos de ganadería
                      sostenible, conectando a consumidores con productores que
                      implementen buenas prácticas.
                    </StyledText>
                  )}
                  {aboutSosty[0] == true && <Separator></Separator>}
                  {aboutSosty[0] == true && (
                  ...
                  {aboutSosty[3] == true && (
                    <StyledText style={styles.innerHelpText} className="mb-1">
                      ...
                      de colaboración empresarial agropecuarios, enfocados en
                      ganadería. Compra, hazle seguimiento y vende ganado a
                      través de Sosty.
                    </StyledText>
                  )}
                  {aboutSosty[0] == true && <Separator></Separator>}
                  ...
                  {aboutSosty[4] == true && (
                    <StyledText style={styles.innerHelpText} className="mb-1">
                      No, En Sosty no realizamos recomendaciones de inversión,
                      somos una compañía comercializadora que facilita la
                      conexión entre productores que están dispuestos a recibir
                      ganado en participación, y personas que desean comprar
                      ganado para llevarlos al aumento con Productores. Sosty
                      brinda la información necesaria para que las partes
                  ...
                  {aboutSosty[5] == true && (
                    <StyledText style={styles.innerHelpText} className="mb-1">
                      ...
                      financiera, aseguradora, establecimiento de crédito o de
                      capitalización, sino una sociedad dedicada a la
