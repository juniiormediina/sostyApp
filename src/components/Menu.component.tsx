...
export const Menu = (props : MenuProps) => {
  ...
  const [colorIconInv, setColorIconInv] = props.activeRoute == 'investment' ? useState('#00BD56'): useState('#D3D3D3');
  const [colorIconSearch, setColorIconSearch] = props.activeRoute == 'search' ? useState('#00BD56'): useState('#D3D3D3');
  const [colorIconQuestion, setColorIconQuestion] = props.activeRoute == 'help' ? useState('#00BD56'): useState('#D3D3D3');
  const [colorIconUser, setColorIconUser] = props.activeRoute == 'user' ? useState('#00BD56'): useState('#D3D3D3');
  return (
